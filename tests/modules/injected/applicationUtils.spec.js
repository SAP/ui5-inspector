...
var basicMock = {
    /**
     * Mock function for ToolsAPI getFrameworkInformation.
     * @returns {Object}
     */
    ...
    describe('#getApplicationInfo()', function () {
        describe('should create an object for the DataView', function () {
            ...
            it('with the common information for the framework', function () {
                ...
                commonInformation['User Agent'].should.be.equal(basicMock.getFrameworkInformation().commonInformation.userAgent);
                commonInformation.Application.should.be.equal(basicMock.getFrameworkInformation().commonInformation.applicationHREF);
            });
            ...
            it('with the bootstrap configuration information for the framework', function () {
                ...
                var mockConfigurationBootstrap = basicMock.getFrameworkInformation().configurationBootstrap;
            ...
            it('with the computed configuration for the inspected page', function () {
                ...
                configurationComputed.should.be.equal(JSON.stringify(basicMock.getFrameworkInformation().configurationComputed));
            });
            ...
            it('with the loaded libraries from the framework', function () {
                ...
                loadedLibraries.should.be.equal(JSON.stringify(basicMock.getFrameworkInformation().loadedLibraries));
            });

            it('with the libraries from the framework', function () {
                var libraries = JSON.stringify(applicationInformation.libraries.data);

                libraries.should.be.equal(JSON.stringify(basicMock.getFrameworkInformation().libraries));
            });
        });
    });
