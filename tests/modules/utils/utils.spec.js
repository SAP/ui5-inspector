...
describe('utils', function () {
    ...
    describe('#applyTheme()', function () {
        ...
        it('should change theme', function () {
            ...
            expect(document.getElementById('ui5inspector-theme').href).to.have.string('/styles/themes/dark.css');

            utils.applyTheme('light');

            expect(document.getElementById('ui5inspector-theme').href).to.have.string('/styles/themes/light.css');
        });
    });
});
